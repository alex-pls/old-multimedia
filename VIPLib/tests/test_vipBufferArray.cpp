/** @file    test_vipBufferArray.cpp
 *
 *  @brief   Testing code for template class vipBufferArray.
 *
 *
 *
 *
...
int main(int argc, char* argv[])
 {
	printf("Testing vipBufferArray Development...\n");

	printf("\nCreating Instances...\n");
	vipBufferArray<vipFrameRGB24Test> myBuffer;
