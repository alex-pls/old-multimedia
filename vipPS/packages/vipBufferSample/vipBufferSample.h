/** @file    vipBufferSample.h
 *  @class   vipBufferSample
 *
 *  @brief
 *
 *
...
#ifndef __VIPLIB_VIPBUFFERSAMPLE_H__
 #define __VIPLIB_VIPBUFFERSAMPLE_H__

 #include "I:\Projects\Software\VIPLib\source\vipBuffer.h"
...
template<class T>
class vipBufferSample : public vipBuffer<T>
 {
	...
	public:
		 ...
		 */
		vipBufferSample() : vipBuffer<T>()
		 {
			INFO("vipBufferSample::vipBufferSample()  : vipBuffer() [CONTRUCTOR]")
		...
		VIPRESULT reset()
		 {
			INFO("int vipBufferSample::reset() [SET DEFAULT PARAMETERS]")
		...
		~vipBufferSample()
		 {
			INFO("vipBufferSample::~vipBufferSample() [DESTRUCTOR]")
		...
		VIPRESULT removeFrame(long index, bool freeData = false)
		 {
			DEBUGMSG("int vipBufferSample::removeFrame(long index)", index)
		...
		VIPRESULT goToNextFrame()
		 {
			INFO("int vipBufferSample::goToNextFrame()")
		...
		VIPRESULT goToFirstFrame()
		 {
			INFO("int vipBufferSample::goToFirstFrame()")
		...
		VIPRESULT goToLastFrame()
		 {
			INFO("int vipBufferSample::goToLastFrame()")
		...
		VIPRESULT goToFrame(long index)
		 {
			DEBUGMSG("int vipBufferSample::goToFrame(long index)", index)
		...
		VIPRESULT goToStepFrame(long offset)
		 {
			DEBUGMSG("int vipBufferSample::goToStepFrame(long offset)", offset)
...
#endif //__VIPLIB_VIPBUFFERSAMPLE_H__
