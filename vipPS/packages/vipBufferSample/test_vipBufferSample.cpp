/** @file    test_vipBufferSample.cpp
 *
 *  @brief   Testing code for class vipBufferSample.
 *
 *
 *
 *
...
int main(int argc, char* argv[])
 {
	...
	printf("Testing vipBufferSample Development...\n");

	printf("\nCreating Instances...\n");
	vipBufferSample<vipFrameYUV420Test> myBuffer;
